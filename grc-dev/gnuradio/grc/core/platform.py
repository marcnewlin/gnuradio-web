...
from .utils.extract_docs import docstring_guess_from_key, docstring_from_make
...
class Platform(Element):
    ...
    def build_library(self, path=None):
        ...
        print("build_library")
        path = "/lib/share/gnuradio/grc/blocks"
    ...
    def load_block_description(self, data, file_path):
        ...
        docstrings = docstring_from_make(block_id, block_cls.templates['imports'], block_cls.templates['make'])
        self._save_docstring_extraction_result(block_id, docstrings)
